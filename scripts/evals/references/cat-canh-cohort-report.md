...
Cohort 1's accelerator runs June to December 2026, with placement support
continuing into the following spring as fellows receive offers and prepare to
depart. The journey moves from preparation through application to placement.

| Phase | Window | Focus |
|-------|--------|-------|
| Preparation | Jun-Sep 2026 | Onboarding, Ambassador pairing, SOP and CV workshops, English preparation |
| Application | Oct-Dec 2026 | Professor outreach, mock interviews, application submission |
| Placement | Mar-May 2027 | Offer analysis, visa and housing guidance, alumni-network induction |
